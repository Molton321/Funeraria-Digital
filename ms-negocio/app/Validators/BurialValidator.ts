...
export default class BurialValidator {
  ...
  public schema = schema.create({
      ...
      service_id: schema.number([rules.exists({ table: 'services', column: 'id' }), rules.unique({ table: 'cremations', column: 'service_id' , where: {service_id: this.ctx.request.input('service_id')}})])
  })
