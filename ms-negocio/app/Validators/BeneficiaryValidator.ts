...
export default class BeneficiaryValidator {
  ...
  public schema = schema.create({
    ...
    client_id: schema.number([rules.exists({ table: 'clients', column: 'id' }), rules.unique({ table: 'owners', column: 'client_id', where: {client_id: this.ctx.request.input('client_id')} })])
  })
