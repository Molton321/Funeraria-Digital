...
export default class CremationValidator {
  ...
  public schema = schema.create({
      ...
      service_id: schema.number([rules.exists({ table: 'services', column: 'id' }), rules.unique({ table: 'burials', column: 'service_id' , where: {service_id: this.ctx.request.input('service_id')}})])
  })
