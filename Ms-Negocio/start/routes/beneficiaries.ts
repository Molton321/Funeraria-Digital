...
Route.group(() => {
  ...
  Route.get('/beneficiaries/client/:client_id/titular/:titular_id', 'BeneficiariesController.findByClientAndTitular') //List all beneficiaries by client_id and titular_id
